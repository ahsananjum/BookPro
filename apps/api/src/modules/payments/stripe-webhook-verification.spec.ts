...
import { TestPaymentAdapter } from "./test-payment.adapter";
        ...
        beforeEach(() => {
            ...
            const mockPrisma: any = {
                ...
                customer: {
                    ...
                    create: async ({ data }: any) => ({ id: testCustomerId, ...data }),
                    update: async () => ({ id: testCustomerId }),
                },
                appointment: {
                ...
                appointmentHistory: {
                    create: async () => ({ id: `ah_${Date.now()}` }),
                },
                intakeResponse: {
                    create: async () => ({ id: `ir_${Date.now()}` }),
                },
                refundRecord: {
                    create: async () => ({ id: `rf_${Date.now()}` }),
                },
