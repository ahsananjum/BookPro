...
export class MockGoogleCalendarAdapter implements CalendarProvider {
    ...
    public eventsStore = new Map<string, Map<string, MockStoreCalendarEvent>>(); // calendarId -> (eventId -> event)
    ...
    async syncEvents(
        ...
        if (this.simulatedErrors.shouldFailSyncWith410 && syncToken) {
            ...
            this.simulatedErrors.shouldFailSyncWith410 = false; // reset after triggering
